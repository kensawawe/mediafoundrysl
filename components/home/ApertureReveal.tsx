...
/**
 * Scroll-pinned reveal: the video is masked behind a small Sierra Leone
 * silhouette that scrolls open to fill the screen, then the page continues.
 * Adapted from a pasted reference (a lip-shaped version of the same
 * mask-size scroll-scrub technique) — reshaped to the country outline,
 * recolored to the site's own theme tokens, and rebuilt on the project's
 * existing `useGSAP` convention (see Hero.tsx) rather than a raw
 * `gsap.context` call.
 */
